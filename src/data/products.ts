...
export const products: Product[] = [
  {
    ...
    description:
      "Blue flame graphic tee inspired by anime fire techniques. Premium cotton construction with bold back print.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
    isSale: true,
  ...
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Bushido warrior spirit captured in ink-style graphic. Heavyweight cotton with distressed details.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Demon blood art tee featuring intricate Japanese folklore artwork. Premium quality with vibrant print.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
    isSale: true,
  ...
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Domain expansion graphic inspired by cursed techniques. Bold design on premium cotton.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Free soul artwork capturing the essence of freedom. Lightweight cotton with spiritual design.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Limitless power graphic tee. Ultra-premium cotton with cosmic-inspired artwork.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Paradise spirit design blending traditional and modern aesthetics. Premium cotton construction.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Warrior spirit embodying the strength of anime heroes. Heavyweight tee with detailed back print.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
    isSale: true,
  ...
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Water breathing technique artwork inspired by swordsmanship anime. Flowing design on premium cotton.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
  },
  {
    ...
    collection: "THE_ORIGIN_DROP",
    description:
      "Will of the sun graphic capturing solar energy and determination. Premium cotton with fiery design.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black"],
    isNew: true,
    isSale: true,
...
export const collections = [
  {
    id: "1",
    name: "THE_ORIGIN_DROP",
    slug: "the-origin-drop",
    description:
      "Our debut collection featuring original anime-inspired graphics. Each piece is limited edition with no restocks.",
    products: products,
  },
];
